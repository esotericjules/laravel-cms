<div class="col-md-4 col-xl-3">
    <div class="sidebar px-4 py-md-0">
      ...
      {{-- <p class=r"small-3">TheSaaS is a responsive, professional, and multipurpose SaaS, Software, Startup and WebApp landing template powered by Bootstrap 4. TheSaaS is a powerful and super flexible tool for any kind of landing pages.</p> --}}
